...
class Apilot(Plugin):
    ...
    def on_handle_context(self, e_context: EventContext):
        ...
        # 走茉莉云
        if "奶子" in content or "黑丝" in content or "白丝" in content or "美女" in content or "点歌" in content or "猜拳" in content or "签到" in content or "抽签" in content or "倒计时" in content:
